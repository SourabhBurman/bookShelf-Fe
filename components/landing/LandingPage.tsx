        ...
        <section className="relative pt-24 pb-32 sm:pt-32 lg:pt-40 lg:pb-40 px-6 lg:px-8 max-w-7xl mx-auto flex flex-col justify-center items-center text-center">
          ...
          <div className="max-w-4xl animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-in-out block">
            ...
            <p className="mt-8 text-lg sm:text-xl leading-8 text-zinc-400 max-w-2xl mx-auto">
              BookShelf gives you the ultimate workspace to track books, manage
              borrowers, and easily enforce penalties. Spend less time managing
              records and more time curating your collection.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link href="/login">
                <Button
                  size="lg"
                  className="h-14 px-8 text-base bg-purple-500 hover:bg-purple-600 text-white font-semibold transition-all shadow-lg hover:shadow-purple-500/25"
                >
          ...
          <div className="py-24 sm:py-32 max-w-7xl mx-auto px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-zinc-400">
                Powerful tools designed specifically to make a librarian&apos;s
                daily workflows faster and easier.
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                <Card className="bg-zinc-900/50 border-white/10 hover:border-purple-500/50 transition-colors backdrop-blur-xl group">
                  ...
                  <CardContent>
                    <CardDescription className="text-zinc-400 text-base">
                      No more missing titles. Easily track which books are
                      available, who is currently renting them, and when they
                      are due back.
                    </CardDescription>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-zinc-900/50 border-white/10 hover:border-purple-500/50 transition-colors backdrop-blur-xl group">
                  <CardHeader>
                    ...
                    <CardTitle className="text-xl text-white">
                      Easy Borrower Management
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <CardDescription className="text-zinc-400 text-base">
                      Organize your borrowers efficiently. View their history,
                      active rentals, and contact information all in one unified
                      dashboard.
                    </CardDescription>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-zinc-900/50 border-white/10 hover:border-purple-500/50 transition-colors backdrop-blur-xl group">
                  ...
                  <CardContent>
                    <CardDescription className="text-zinc-400 text-base">
                      Dynamically calculate late fines. The system handles all
                      the math and automatically deducts the necessary balances
                      on return.
                    </CardDescription>
                  </CardContent>
                </Card>

...
export default function SignupPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-zinc-950 text-zinc-50 overflow-hidden font-sans selection:bg-purple-500/30 items-center justify-center relative py-12">
      ...
      <div className="w-full max-w-md px-4 z-10 animate-in fade-in zoom-in-95 slide-in-from-bottom-8 duration-700 ease-in-out fill-mode-both mt-8 sm:mt-0">
        <div className="flex justify-center mb-6">
          <div className="h-12 w-12 rounded-xl bg-purple-500/10 flex items-center justify-center shadow-inner">
        ...
        <Card className="bg-zinc-900/70 border-white/10 backdrop-blur-xl shadow-2xl overflow-hidden relative">
          ...
          <Form of={signupForm} onSubmit={handleFormSubmission}>
            <CardContent className="space-y-5 pb-4">
              ...
              <Field of={signupForm} path={["confirmPassword"]}>
                {(field) => (
                  <div className="space-y-2 group">
                    <Label
            ...
            <CardFooter className="flex flex-col gap-5 pt-4 pb-4 bg-zinc-900/70 border-white/10 backdrop-blur-xl">
              <Button
                type="submit"

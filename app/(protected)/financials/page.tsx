        ...
        <Card className="bg-zinc-900/50 border-white/5 backdrop-blur-xl lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription className="text-zinc-400">
              Monthly breakdown of your earnings sources.
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <tbody className="divide-y divide-white/5">
                {transactions.map((tx) => (
                  ...
                  >
                    ...
                    <td
                      className={`px-6 py-4 font-medium ${tx.amount.startsWith("+") ? "text-emerald-400" : "text-rose-400"}`}
                    >
                      {tx.amount}
                    </td>

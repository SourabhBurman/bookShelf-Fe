...
export type PlaceOrderMutation = { placeOrder: Array<{ __typename: 'Order', id: string | null, transactionType: Types.TransactionType | null, transactionDate: unknown } | null> };

...
export type GetBooksQuery = { getBooks: Array<{ __typename: 'Book', id: string | null, name: string | null, description: string | null, genre: Types.Genre | null, quantityAvailable: number | null, cost: number | null, rentPrice: number | null, publishedDate: unknown }> };
...
export type GetBookByIdQuery = { getBook: { __typename: 'Book', id: string | null, name: string | null, description: string | null, genre: Types.Genre | null, quantityAvailable: number | null, cost: number | null, rentPrice: number | null, publishedDate: unknown } | null };
